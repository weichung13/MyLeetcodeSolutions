...
public class solution733 {
    public int[][] floodFill(int[][] image, int sr, int sc, int color) {
        ...
        //check if the original color is equal to the desire color, if true return
        if(originColor != color){
            ...
            while(!stack.isEmpty()){
                ...
                //pop[0] is the row index, pop[1] is the column index
                if(image[pop[0]][pop[1]] == originColor){

                    //turn the starting point to the desired color
                    image[pop[0]][pop[1]] = color;

                    //do the DFS for four directions 
                    if(pop[0]>0){
